pageextension 51907 "ACC Sales List Ext" extends "Sales Order List"
{
    ...
    begin
        ...
        exit(GetSelectionFilterForStatisticsGroup(SalesTable));
    end;

    local procedure GetSelectionFilterForStatisticsGroup(var SalesTable: Record "Sales Header"): Text
    var
        RecRef: RecordRef;
    begin
        RecRef.GetTable(SalesTable);
        exit(GetSelectionFilter(RecRef, SalesTable.FieldNo("No.")));
    end;
