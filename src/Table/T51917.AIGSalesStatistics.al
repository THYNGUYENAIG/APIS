table 51917 "AIG Sales Statistics"
{
    ...
    fields
    {
        ...
        field(18; "Charge Amount"; Decimal)
        {
            ...
            FieldClass = FlowField;
            DecimalPlaces = 0 : 2;
            CalcFormula = lookup("AIG Value Entry Relation"."Charge Amount" where("Invoice No." = field("Document No."),
                                                                                  "Invoice Line No." = field("Line No."),
                                                                                  "Posting Date" = field("Posting Date")));
        }
        ...
        field(58; "eInvoice Series"; Code[20])
        {
            ...
            Editable = false;
            FieldClass = FlowField;
            CalcFormula = lookup("BLTI eInvoice Register"."eInvoice Series" where("eInvoice No." = field("Invoice No.")));
        }
