query 51913 "ACC Forecast SA Group Entry"
{
    Caption = 'APIS Forecast Agreement Group Entry';
    ...
    elements
    {
        dataitem(SalesInvoiceLine; "Sales Invoice Line")
        {
            ...
            dataitem(SalesInvoiceHeader; "Sales Invoice Header")
            {
                ...
                {
                    DataItemTableFilter = "BLACC Owner Group" = filter(<> '');
                    DataItemLink = "No." = SalesInvoiceHeader."Sell-to Customer No.";
                    SqlJoinType = InnerJoin;
                    column(AgreementGroup; "BLACC Owner Group") { }
                }
            }
        }
    }
