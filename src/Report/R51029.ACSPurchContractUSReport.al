report 51029 "ACS Purch Contract US Report"
{
    ApplicationArea = All;
    Caption = 'ACS Purchase Contract US Report - R51029';
    UsageCategory = ReportsAndAnalysis;
    DataAccessIntent = ReadOnly;
    DefaultLayout = RDLC;
    RDLCLayout = 'src/Layout/R51029.ACSPurchContractUSReport.rdl';
    dataset
    {
    ...
    begin
        ...
        AmountInWords.AmountInWordsForReport(PurchAmount, CurrencyCode, PurchAmount, AmountLetter, AmountENLetter, EquivalentENLetter);
